...
INSERT INTO `records` VALUES (1,'Oliver','o@e.com','90347347348','System','2021-02-02 11:58:00','System','2021-02-02 11:58:00',_binary ''),(2,'John','a@e.com','938498384398','System','2021-02-09 11:26:05','System','2021-02-09 11:26:05',_binary ''),(3,'r@e.com','r@@e.com','3049830948390','System','2021-02-14 12:13:54','System','2021-02-14 12:13:54',_binary '');
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `DeleteRecord`(IdVal int)
BEGIN
UPDATE Records
SET IS_ACTIVE = 0
WHERE Id = IdVal;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetRecord`(RecordId int)
BEGIN
SELECT * FROM Records 
	WHERE Id = RecordId
	AND IS_ACTIVE = 1;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `InsertRecord`(NameVal VARCHAR(100), EmailVal VARCHAR(250), ContactVal VARCHAR(50))
BEGIN
INSERT INTO Records(
	Name,
	Email, 
...
-- Dump completed on 2021-04-13 18:31:00
